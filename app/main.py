...
import numpy as np
from joblib import load  # updated for current environment
...
def add_predictions(input_data):
    model = load("model/model.joblib")  # joblib compatible
    ...
    st.write(f"Probability of being benign: {probabilities[0]:.2f}")
    st.write(f"Probability of being malignant: {probabilities[1]:.2f}")
    st.write(
...
def main():
    st.set_page_config(
        page_title="Breast Cancer Prediction Using Logistic Regression",
    ...
    with st.container():
        ...
        st.write(
            ...
            "This app is made for Minor Project of BCT (6th Semester)."
        )
